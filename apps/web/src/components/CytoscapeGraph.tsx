      ...
      style: [
        ...
        },
        {
          ...
          style: {
            ...
            'transition-property': 'opacity, line-color, target-arrow-color, text-opacity',
            'transition-duration': 200,
          },
        },
        {
    ...
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      >
        <button
          type="button"
          onClick={handleFit}
          style={{ width: 28, height: 28, background: 'transparent', border: 'none', color: '#cbd5e1', cursor: 'pointer', fontSize: 12 }}
          title="Fit Graph"
        >
          [ ]
        </button>
        <button
          ...
          style={{ width: 28, height: 28, background: 'transparent', border: 'none', color: '#cbd5e1', cursor: 'pointer', fontSize: 18 }}
          title="Zoom In"
        >
          +
        </button>
        <button
          ...
          style={{ width: 28, height: 28, background: 'transparent', border: 'none', color: '#cbd5e1', cursor: 'pointer', fontSize: 22, lineHeight: 1 }}
          title="Zoom Out"
        >
          -
        </button>
      ...
      {tooltip && tooltip.visible && (
        ...
        >
          ...
          <div style={{ color: '#94a3b8', fontSize: 11 }}>
            Type: <span style={{ color: '#e2e8f0', textTransform: 'capitalize' }}>{tooltip.type}</span>
          </div>
          <div style={{ color: '#94a3b8', fontSize: 11 }}>
            Evidence: <span style={{ color: '#e2e8f0' }}>{tooltip.evidenceCount}</span>
          </div>
        </div>
      )}
    </div>
